...
void Cube::RenderPrimitive(const std::shared_ptr<Raster>& raster, const YGM::Transform & model)
{
}

void Cube::RenderShadowPrimitive(const std::shared_ptr<ShadowGen>& shadowgen, const YGM::Transform & model)
{
}
